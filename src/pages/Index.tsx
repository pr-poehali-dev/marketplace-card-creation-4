        ...
        <div className="relative p-12">
          ...
          <div className="relative flex justify-center mb-16" style={{ minHeight: '500px' }}>
            ...
            <svg className="absolute inset-0 w-full h-full pointer-events-none" style={{ zIndex: 20 }}>
              <line x1="25%" y1="85%" x2="20%" y2="85%" stroke="black" strokeWidth="2" />
              <line x1="45%" y1="85%" x2="50%" y2="85%" stroke="black" strokeWidth="2" />
              <line x1="20%" y1="85%" x2="50%" y2="85%" stroke="black" strokeWidth="2.5" markerStart="url(#arrowhead-left)" markerEnd="url(#arrowhead-right)" />
              <text x="35%" y="90%" fill="black" fontSize="20" fontWeight="bold" fontFamily="Roboto, sans-serif" textAnchor="middle">
                67мм
              </text>
              
              <line x1="50%" y1="85%" x2="55%" y2="85%" stroke="black" strokeWidth="2" />
              <line x1="75%" y1="85%" x2="80%" y2="85%" stroke="black" strokeWidth="2" />
              <line x1="55%" y1="85%" x2="80%" y2="85%" stroke="black" strokeWidth="2.5" markerStart="url(#arrowhead-left)" markerEnd="url(#arrowhead-right)" />
              <text x="67.5%" y="90%" fill="black" fontSize="20" fontWeight="bold" fontFamily="Roboto, sans-serif" textAnchor="middle">
                83мм
              </text>
              
              <line x1="85%" y1="30%" x2="85%" y2="25%" stroke="black" strokeWidth="2" />
              <line x1="85%" y1="70%" x2="85%" y2="75%" stroke="black" strokeWidth="2" />
              <line x1="85%" y1="25%" x2="85%" y2="75%" stroke="black" strokeWidth="2.5" markerStart="url(#arrowhead-up)" markerEnd="url(#arrowhead-down)" />
              <text x="89%" y="51%" fill="black" fontSize="20" fontWeight="bold" fontFamily="Roboto, sans-serif" textAnchor="start">
                85мм
              </text>
